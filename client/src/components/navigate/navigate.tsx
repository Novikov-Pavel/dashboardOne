...
import { navBottomT, navTopT } from './types'
import '../../SASS/navigate.scss'

function Navigate() {
  let navTop: navTopT = [faCompass, faStar, faFB, faTrendingUp, faSocialPublicon, faSocialLocationCity]
  let navBottom: navBottomT = [Avatar1, Avatar2, Avatar3, Avatar4, faAddCircle]
